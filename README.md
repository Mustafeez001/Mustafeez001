...
<h3 align="center">A passionate JAVA Back-End Developer, Dedicated to develope robust applications that interact with the Backend part of web applications. Extensive expertise in website architecture, design, web design, and web API designs. Problem-solving mindset to optimize my application for better stability and speed. Love to work in a team.</h3>
